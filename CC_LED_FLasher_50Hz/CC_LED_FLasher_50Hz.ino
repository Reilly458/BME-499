...
void timer3_init(void) {
	...
	*/
	...
	OCR3A = 311;                        // Set threshold for exactly 50ms intervals, Set count limit: (16000000Hz / 256 clock speed) * 0.005 seconds - 1 = 311 ticks
	/*
...
ISR(TIMER3_COMPA_vect) {
  ...
  switch(state){
        ...
        LEDsoff();  //Turn both leds off, dark phase
				          // Drop both outputs to 0% PWM
        ...
        adc_a0 = adc_read(0)-ambientDC;            // Read A0 (LED 1 Active DC) 740nm
			...
			case 3:     
        updateLED1(OXY_850NM, BRIGHT850);     // Turn LED 2 to 100% full scale
